...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // UserRole enum: Customer=1, Employee=2, Admin=3
    ...
    <div className="min-h-screen flex items-center justify-center px-4 md:px-6 py-12 relative overflow-x-hidden">
      ...
      >
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <p className="text-muted-foreground text-center mb-8">برای دسترسی به داشبورد وارد شوید</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" disabled={isLoading} className="w-full btn-primary shadow-glow">
              {isLoading ? (
