    ...
    <main className="min-h-screen bg-transparent">
      ...
      <section className="relative min-h-screen overflow-hidden px-6 pb-24 pt-32">
        ...
        <div className="container relative mx-auto">
          ...
          >
            <span className="text-sm font-medium text-sky-600 dark:text-cyan-400">تعرفه‌های آرین پژوهش</span>
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-muted-foreground md:text-lg">
              قیمت‌ها، زمان تحویل و امکانات هر پلن مستقیماً از سامانه آرین پژوهش دریافت می‌شوند.
            </p>
          </motion.header>
