...
export default function AdminServicesPage() {
  ...
  const fields: FormField[] = [
    ...
    { key: 'displayOrder', label: 'ترتیب نمایش', type: 'number' },
    {
      ...
      type: 'select',
      options: [
        { value: 'shopping-cart', label: 'سبد خرید — سایت فروشگاهی' },
        { value: 'building-2', label: 'ساختمان — سایت شرکتی' },
        { value: 'code-2', label: 'کدنویسی — سایت سفارشی' },
        { value: 'smartphone', label: 'موبایل — اپلیکیشن' },
        { value: 'layout-dashboard', label: 'داشبورد مدیریت' },
        { value: 'globe-2', label: 'وب‌سایت عمومی' },
        { value: 'palette', label: 'طراحی رابط کاربری' },
        { value: 'server', label: 'سرور و بک‌اند' },
        { value: 'briefcase-business', label: 'کسب‌وکار' },
      ],
    },
