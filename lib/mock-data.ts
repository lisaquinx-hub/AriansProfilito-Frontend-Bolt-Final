...
export const projects: Project[] = [
  {
    ...
    longDescription: 'پلتفرم ابری نوا یک راه‌حل جامع برای مدیریت زیرساخت ابری است. این پروژه شامل طراحی دوباره تجربه کاربری و ساختن داشبوردهای پیشرفته بود.',
...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'روندهای جدید در طراحی UX و نحوه پیاده‌سازی آن‌ها در محصولات دیجیتال ایرانی.',
 ...
 طراحی مینیمال، انیمیشن‌های ظریف، و تمرکز بر دسترسی‌پذیری از مهم‌ترین روندهای امسال هستند.`,
  ...
  },
  {
    ...
    title: 'معماری میکروسرویس برای استارتاپ‌ها',
...
export const testimonials: Testimonial[] = [
  ...
  {
    id: '4',
    quote: 'از طراحی تا اجرا، تیم آریان پژوهش همواره حرفه‌ای و دقیق بود. نتیجه کار از انتظارات ما فراتر رفت.',
    author: 'محمد رضایی',
...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    name: 'حرفه‌ای',
    price: '۳۵,۰۰۰,۰۰۰',
    description: 'مناسب برای استارتاپ‌ها و کسب‌وکارهای در حال رشد',
    features: [
      'همه امکانات پایه',
      'طراحی و توسعه کامل',
      'API Integration',
